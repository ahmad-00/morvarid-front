	...
	get items() {
		return [
			...
			},
			{
				...
				text:
					'هزینه ارسال سفارشات بالای یک میلیون تومان برای مشتریان ساکن شهر تهران رایگان میباشد و کمتر از یک میلیون تومان مبلغ چهل هزار تومان به مبلغ فاکتور شما جهت ارسال اضافه میشود. \n' +
