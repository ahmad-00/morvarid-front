<template>
	<div class="flex flex-col items-center justify-center">
		<div class="flex flex-col items-start mt-20 mb-32">
			...
			<div v-if="info.buttonLink && info.buttonText" class="flex items-center mt-8">
				<nuxt-link
	...
	get info() {
		if (this.type === "successful") {
			return {
				...
				subtitle:
					this.$strings.thank_you_for_your_purchase_and_trust(),
				message:
			...
			return {
				...
				subtitle:
					this.$strings.payment_operation_was_unsuccessful(),
